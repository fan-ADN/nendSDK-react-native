...
import {VideoNativeAdLoader, MediaView, UserFeature} from 'react-native-nend-bridger';
import type {VideoNativeAd} from 'react-native-nend-bridger';
...
export default class VideoNative extends React.Component<{}, State> {
    ...
    constructor() {
        ...
        if (Platform.OS === 'ios') {
            ...
            this._adLoader.setUserId('887595', 'fan-taro');
        } else {
            this._adLoader = new VideoNativeAdLoader('887591', 'a284d892c3617bf5705facd3bfd8e9934a8b2491', 'LP');
            this._adLoader.setUserId('887595', 'fan-taro');
        }
